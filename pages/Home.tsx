    ...
    <>
      ...
      <main className="max-w-md mx-auto pb-24">
        ...
        <div className="grid grid-cols-2 gap-4 p-4">
          ...
          <div 
            onClick={() => navigate(`/service/parking-systems`)}
          ...
          >
            ...
            >
              <div className="absolute top-2 left-2 bg-background-dark/60 backdrop-blur-sm p-1.5 rounded-lg">
                <span className="material-symbols-outlined text-primary text-sm">{SERVICES[4].icon}</span>
              </div>
            </div>
            <div>
              <p className="text-slate-900 dark:text-white text-sm font-bold leading-snug">{SERVICES[4].title}</p>
              <p className="text-silver-accent text-xs font-normal mt-1 leading-normal">{SERVICES[4].description}</p>
            </div>
          </div>
        </div>
